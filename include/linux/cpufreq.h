...
#elif defined(CONFIG_CPU_FREQ_DEFAULT_GOV_INTERSCHEDUTIL)
extern struct cpufreq_governor cpufreq_gov_interschedutil;
#define CPUFREQ_DEFAULT_GOVERNOR	(&cpufreq_gov_interschedutil)
#endif
